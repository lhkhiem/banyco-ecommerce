...
exports.normalizeMediaUrl = exports.replaceIpWithDomain = exports.isProductionDomain = exports.getApiUrl = exports.getAdminDomain = exports.getSiteUrl = exports.getFrontendDomain = exports.getApiDomain = void 0;
/**
...
const getFrontendDomain = () => {
    ...
    const envDomain = process.env.FRONTEND_DOMAIN ||
 ...
 */
const getSiteUrl = () => {
    const rawDomain = (0, exports.getFrontendDomain)();
