...
exports.getContactNotificationTemplate = getContactNotificationTemplate;
exports.getContactConfirmationTemplate = getContactConfirmationTemplate;
exports.getContactReplyTemplate = getContactReplyTemplate;
 ...
 */
function getContactReplyTemplate(data) {
    const subjectLabels = {
        product: 'Product Inquiry',
        order: 'Order Status',
        support: 'Technical Support',
