...
// Note: Only public route (submitConsultation) is used in Ecommerce Backend
// Admin routes (getConsultations, updateConsultation, etc.) are in CMS Backend
...
// Admin routes are handled by CMS Backend
export const getConsultations = async (req: any, res: Response) => {
  try {
    const {
      status,
      province,
...
// Note: This function is kept for reference but not used in Ecommerce Backend
export const getConsultationById = async (req: any, res: Response) => {
  try {
    const { id } = req.params;
...
// Note: This function is kept for reference but not used in Ecommerce Backend
export const updateConsultation = async (req: any, res: Response) => {
  try {
    const { id } = req.params;
    const {
      status,
...
// Note: This function is kept for reference but not used in Ecommerce Backend
export const deleteConsultation = async (req: any, res: Response) => {
  try {
    const { id } = req.params;
...
// Note: This function is kept for reference but not used in Ecommerce Backend
export const getConsultationStats = async (req: any, res: Response) => {
  try {
    const statsQuery = `
      SELECT 
        COUNT(*) as total,
